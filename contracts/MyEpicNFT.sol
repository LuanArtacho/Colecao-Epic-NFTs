...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Jucelino", "Robjhonson", "Agjhones", "Flompson", "Jaymis", "Braulio", "Aricleio", "Mohamed", "Will", "Bobson", "Xambis", "Juao", "Jhoson"];
  string[] secondWords = ["Careca", "Calvo", "Barbudo", "Manco", "Caolho", "Corno", "Puto", "Manso", "Calmo", "Segueta", "Gordo", "Baixo", "Pequeno", "Capenga", "Desnutrido"];
  string[] thirdWords = ["Azul", "Amarelo", "Vermelho", "Verde", "Laranja", "Roxo", "Rosa", "Marrom", "Preto", "Cinza", "Branco", "Violeta", "Dourado"];
